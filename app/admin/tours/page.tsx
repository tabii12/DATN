...
export default function AdminTours() {
  ...
  const filtered = tours.filter((t) => {
    ...
    const matchSearch =
      ...
      t.hotel_id?.city?.toLowerCase().includes(q);
    const matchStatus =
      filterStatus === "all" ||
      (filterStatus === "active"
        ? t.status === "active"
    ...
    <div className="min-h-screen bg-gray-50 font-sans">
      ...
      <div className="max-w-full mx-auto px-4 py-6">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-4 mb-4 flex flex-wrap items-center gap-3">
          {/* Search */}
          <div className="flex items-center gap-2 bg-gray-50 rounded-xl px-3 py-2.5 flex-1 min-w-55">
            <svg
                ...
                {paginated.map((t, i) => (
                  ...
                  >
                    ...
                    <td className="px-5 py-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="min-w-0">
                          ...
                          <p className="text-[11px] text-gray-400 font-mono truncate max-w-50">
                            {t.slug}
                          </p>
                        </div>
                      </div>
                    ...
                    <td className="px-4 py-3 hidden lg:table-cell">
                      {t.category_id?.name ? (
                        <span className="text-[11px] bg-orange-50 text-orange-500 font-semibold px-2.5 py-1 rounded-full">
                          {t.category_id.name}
                        </span>
                      ) : (
                        <span className="text-gray-300 text-sm">—</span>
