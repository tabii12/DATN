      ...
      <div className="bg-white border-b border-gray-100 px-6 py-4 flex items-center gap-3 sticky top-0 z-10">
        ...
        <div>
          ...
          <p className="text-xs text-gray-400">
            Điền thông tin để thêm tour vào hệ thống
          </p>
        </div>
      </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    // Tự động set nights = d - 1
                    setForm((f) => ({ ...f, duration: d, nights: d - 1 }));
                  }}
              ...
              <div>
                ...
                <input
                  type="number"
                  value={form.nights}
                  readOnly // Khóa không cho người dùng sửa trực tiếp
                  className="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm bg-gray-50 text-gray-400 outline-none text-center font-bold cursor-not-allowed"
                />
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              {(
                ...
                >
                  ...
                  <p
                    className={`text-sm font-bold ${form.status === v ? "text-orange-700" : "text-gray-700"}`}
                  >
                    {label}
                  </p>
