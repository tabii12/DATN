        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {selected === "momo" && (
            <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 flex flex-col items-center gap-4">
              <p className="text-sm text-slate-500 self-start">Mở app MoMo → Quét mã bên dưới để thanh toán</p>
              ...
              <p className="text-sm text-slate-500">Số tiền: <span className="font-bold text-pink-600">{formatVND(total)}</span></p>
            </div>
          )}
