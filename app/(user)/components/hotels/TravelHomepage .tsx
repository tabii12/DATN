...
const COMBO_DEALS = [
  {
    ...
    stars: 4,
    tag: "Combo",
    image: "https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?w=400&h=260&fit=crop",
  },
  {
    id: 2,
    ...
    stars: 5,
    tag: "Hot",
    image: "https://images.unsplash.com/photo-1571896349842-33c89424de2d?w=400&h=260&fit=crop",
  },
  {
    id: 3,
    ...
    stars: 5,
    tag: "Sale",
    image: "https://images.unsplash.com/photo-1540541338287-41700207dee6?w=400&h=260&fit=crop",
  },
  {
    id: 4,
    ...
    stars: 5,
    tag: "Combo",
    image: "https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?w=400&h=260&fit=crop",
  },
  {
    id: 5,
    ...
    stars: 4,
    tag: null,
    image: "https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?w=400&h=260&fit=crop",
  },
  {
    id: 6,
    ...
    stars: 5,
    tag: "Hot",
    image: "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=400&h=260&fit=crop",
  },
  {
    id: 7,
  ...
  },
  {
    ...
    stars: 5,
    tag: null,
    image: "https://images.unsplash.com/photo-1445019980597-93fa8acb246c?w=400&h=260&fit=crop",
  },
];
...
const TRAVEL_STYLES = [
  {
    ...
    image: "https://images.unsplash.com/photo-1536599018102-9f803c140fc1?w=300&h=200&fit=crop",
...
const DOMESTIC_DESTINATIONS = [
  { name: "Phú Quốc", count: "921", image: "https://images.unsplash.com/photo-1559628233-100c798642d0?w=400&h=300&fit=crop", href: "/khach-san-phu-quoc", colSpan: 2, rowSpan: 2, height: "h-full" },
  { name: "Vũng Tàu", count: "705", image: "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=300&h=200&fit=crop", href: "/khach-san-vung-tau" },
  { name: "Đà Lạt", count: "1178", image: "https://images.unsplash.com/photo-1551632436-cbf8dd35adfa?w=300&h=200&fit=crop", href: "/khach-san-da-lat" },
  { name: "Quy Nhơn", count: "333", image: "https://images.unsplash.com/photo-1583417319070-4a69db38a482?w=300&h=200&fit=crop", href: "/khach-san-quy-nhon" },
  { name: "Nha Trang", count: "1024", image: "https://images.unsplash.com/photo-1528360983277-13d401cdc186?w=300&h=200&fit=crop", href: "/khach-san-nha-trang" },
  { name: "Cần thơ", count: "1359", image: "https://images.unsplash.com/photo-1559628129-67cf63b72248?w=300&h=200&fit=crop", href: "/khach-san-da-nang", colSpan: 2, height: "h-40" },
  { name: "Phan Thiết", count: "498", image: "https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?w=300&h=200&fit=crop", href: "/khach-san-phan-thiet" },
];

const INTERNATIONAL_DESTINATIONS = [
  { name: "Singapore", count: "718", image: "https://images.unsplash.com/photo-1525625293386-3f8f99389edd?w=400&h=280&fit=crop", href: "/khach-san-singapore" },
  { name: "Bangkok", count: "4211", image: "https://images.unsplash.com/photo-1563492065-9083d0abb967?w=400&h=280&fit=crop", href: "/khach-san-bangkok" },
  { name: "Seoul", count: "2490", image: "https://images.unsplash.com/photo-1538485399081-7191377e8241?w=400&h=280&fit=crop", href: "/khach-san-seoul" },
  { name: "Tokyo", count: "3869", image: "https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?w=400&h=280&fit=crop", href: "/khach-san-tokyo" },
  { name: "Thượng Hải", count: "3548", image: "https://images.unsplash.com/photo-1548919973-5cef591cdbc9?w=400&h=280&fit=crop", href: "/khach-san-shanghai" },
  { name: "Maldives", count: "849", image: "https://images.unsplash.com/photo-1514282401047-d79a71a590e8?w=400&h=280&fit=crop", href: "/khach-san-maldives" },
];
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex gap-2">
              ...
              <button
                onClick={() => setSlideIdx((p) => Math.min(COMBO_DEALS.length - 1, p + 1))}
        ...
        <div className="relative overflow-hidden rounded-2xl shadow-md cursor-pointer group">
          ...
          >
            {COMBO_DEALS.map((deal) => (
              <div key={deal.id} className="relative w-full flex-shrink-0 h-[220px] md:h-[280px]">
                {/* Ảnh nền */}
                <img
                  src={deal.image}
                  alt={deal.name}
                ...
                <div className="absolute inset-0 flex flex-col items-end justify-center pr-8 md:pr-14 text-right gap-1">
                  ...
                  {/* Sub label */}
                  <p className="text-white/70 text-xs tracking-[0.2em] uppercase">Combo 2N1Đ</p>
                  {/* Hotel name */}
      ...
      <section className="max-w-7xl mx-auto px-4 py-4 pb-10">
        ...
        >
          ...
          <div className="col-span-2 grid grid-cols-2 gap-2">
            ...
            >
              <img
                src={DOMESTIC_DESTINATIONS[5]?.image ?? DOMESTIC_DESTINATIONS[0].image}
                alt="Cần Thơ"
                className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent" />
